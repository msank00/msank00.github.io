...
- **Base Paper 2007**: Predicting Clicks: Estimating the Click-Through Rate for New Ads
- Paper: An Effective Budget Management Framework for Real-time Bidding in Online Advertising
- Paper: A CTR prediction model based on user interest via attention mechanism
- Paper: A Context-Aware Click Model for Web Search
- WSDM 2020: Interpretable Click-Through Rate Prediction through Hierarchical Attention
- Paper: Learning Compositional, Visual and Relational Representations for CTR Prediction in Sponsored Search
- TOIS 2019: Constructing Click Model for Mobile Search with Viewport Time
- Paper: Improving Ad Click Prediction by Considering Non-displayed Events
- KDD 2019: Generating Better Search Engine Text Advertisements with Deep Reinforcement Learning
- Review Paper: Click-through Rate Prediction In Practice: A study of a click-through rate prediction system
- Paper: Selecting multiple web adverts: A contextual multiarmed bandit with state uncertainty
- KDD 2013: Ad Click Prediction: a View from the Trenches - from **_Google_**
- ADKDD 2014: Practical Lessons from Predicting Clicks on Ads at Facebook
- Thesis 2019: Click-Through Rate Prediction in Practice by Kurt-Eerik Ståhlberg
