...
<center>
<img src="../assets/images/image_07_ctr_1.png" height="200">
</center>
...
Thus, ideally order a set of ads, it is important to be able to accurately estimate the $p(click)*(CTR)$ for a given ad. For ads that have been shown to users many times (ads that have many impressions), this estimate is simply the `binomial MLE` (maximum likelihood estimation), $n_{clicks} / n_{impressions}$.
...
<center>
<img src="../assets/images/image_07_ctr_2.png" height="200">
</center>
...
- <a id="13">[13]</a> Thesis 2019: Click-Through Rate Prediction in Practice by Kurt-Eerik Ståhlberg
