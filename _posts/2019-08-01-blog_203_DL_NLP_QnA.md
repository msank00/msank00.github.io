...
4. [x] How would you find all the occurrences of quoted text in a news article?
5. [x] How would you build a system that auto corrects text that has been generated by a speech recognition system?
6. [x] What is latent semantic indexing and where can it be applied?
7. [x] How would you build a system to translate English text to Greek and vice-versa?
8. [x] How would you build a system that automatically groups news articles by subject?
...
11. [x] Do you know about latent semantic indexing? Where can you apply it?
12. [x] Is it possible to find all the occurrences of quoted text in an article? If yes, explain how?
13. [x] What is a POS tagger? Explain the simplest approach to build a POS tagger?
...
18. [x] How will you train a model to identify whether the word “Raymond” in a sentence represents a person’s name or a company?
19. Which is better to use while extracting features character n-grams or word n-grams? Why?
20. [x] What is a POS tagger? How can you built one?
...
28. [x] What is part of speech (POS) tagging? What is the simplest approach to building a POS tagger that you can imagine?
